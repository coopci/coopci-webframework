package springless.http.grizzly.handlers.mapping.service;
...
/**
 * 把service 的各个接口方法（被  {@link springless.http.grizzly.handlergenerator.MappingToPath}标注的方法 ）注册到httpserver上。 
 * 
 **/
