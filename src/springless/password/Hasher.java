...
public class Hasher {
    ...
    public static void main(String[] args) {
        ...
        String hash = hasher.encode("1", "LYW0mxBwAC6H", 36000);
        System.out.println("1  =======> " + hash);
        
        boolean result = hasher.checkPassword("1", "pbkdf2_sha256$1000$3DqxklPQgco1$dK8RVsfD1guTVBj+S0ps1N+92IRVIlPftDx8M4llz/c=");
